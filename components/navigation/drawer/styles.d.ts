...
}, "style" | "children" | "className" | "classes" | "sx" | "variant" | "color" | "elevation" | "square" | "position" | "enableColorOnDark"> & import('@mui/system').MUIStyledCommonProps<import('@mui/material').Theme> & AppBarProps, {}, {}>;
export {};
