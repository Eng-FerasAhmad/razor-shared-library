...
describe('<Button />', () => {
    test('should render the primary button', () => {
        render(<Button label="button" clickHandler={jest.fn()} color='primary' />);
    ...
    test('should render the success button', () => {
        render(<Button label="button" clickHandler={jest.fn()} color='success' />);
    ...
    test('should render the error button', () => {
        render(<Button label="button" clickHandler={jest.fn()} color='error' />);
    ...
    test('should render the warning button', () => {
        render(<Button label="button" clickHandler={jest.fn()} color='warning' />);
    ...
    test('should render the outline button', () => {
        render(<Button label="button" clickHandler={jest.fn()} variant='outline' />);
    ...
    test('should render the disabled button', () => {
        render(<Button label="button" clickHandler={jest.fn()} disabled={true} />);
