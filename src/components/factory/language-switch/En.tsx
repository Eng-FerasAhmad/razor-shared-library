...
export default function EnIcon(): ReactElement {
    return (
        <svg
            width="22"
            height="16"
        ...
        >
            <g clipPath="url(#clip0_412_3711)">
                <g clipPath="url(#clip1_412_3711)">
                    ...
                    <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M19.9049 0H22.0001V2.66667C22.0001 2.66667 8.39135 11.5499 2.09536 16H0.00012207V13.3333L19.9049 0Z"
                        fill="white"
                    />
                    <path
            ...
            <defs>
                <clipPath id="clip0_412_3711">
                    <rect width="22" height="16" fill="white" />
                </clipPath>
                <clipPath id="clip1_412_3711">
